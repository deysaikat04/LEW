...
//-------------------Items--------------------
	...
	mysql_query("INSERT INTO  parties (InvoiceNo,BillDate,Messers,MessersAdd,GSTNo,Through,StateCode,LRRRNo,PrivateMark,
		DocThrough,NoOfBags,Packing,Postage,TaxableAmnt,SGSTRate,SGSTAmnt,CGSTRate,CGSTAmnt,IGSTRate,IGSTAmnt,GrandTotal,Rupees) 
	VALUES('{$_POST['taxNo']}','{$_POST['bdate']}','{$_POST['mess']}','{$_POST['ma']}','{$_POST['gstNo']}','{$_POST['through']}','{$_POST['state']}',
		'{$_POST['lrNo']}','{$_POST['pMark']}','{$_POST['docThr']}','{$_POST['noOfBeg']}','{$_POST['pkg']}','{$_POST['postg']}','{$_POST['tamnt']}'
