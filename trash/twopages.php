...
//**************-----------------------------********************************
    ...
    $this-> Line(150,233,201,233);// postage bottom border
...
if($count>24)
{
  $pdf->AddPage();
    ...
    $pdf->SetFont('Arial','',9);
    $pdf->design();
    $pdf->ItemsTable($header,2);
    $pdf->LowerTable1($lowerheader);
    $pdf->endpart();
    ...
    $pdf->SetFont('Arial','',9);
    $pdf->design2();
    $pdf->ItemsTable2($header,$count);
    $pdf->LowerTable2($lowerheader);
    $pdf->endpart();
    $pdf->Output();
