	...
	<div class="navbar navbar-default header-highlight">
		...
		<div class="navbar-collapse collapse" id="navbar-mobile">
			...
			<div class="navbar-right">
				...
				<p class="navbar-text"><a href="logout.php" style='text-decoration:none; color:#ff6363;'>Log out</a></p>
			</div>
			<div class="navbar-right">

				<p class="navbar-text"><a href="getpdf.php" style='text-decoration:none;color:#11bed4;'>
			...
			<div class="content-wrapper">
				...
				<div class="content">
		            ...
		            <div class="panel panel-white">
	                	...
	                	<form class="steps-basic" action="submit.php" method="post" id="submitForm">
							...
							<fieldset>
								<div class="row">
									...
									<div class="col-md-6">
										<div class="form-group">
											<label>Date :</label>
											<input type="text" class="form-control pickadate-editable" name="bdate">
										</div>
									</div>
								</div>
								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" name="lrNo" class="form-control required">
										</div>
									</div>
